...
also configure it to use PostgreSQL by passing the `BOW_DATABASE_URL` environment
variable.
...
For example: `BOW_DATABASE_URL=postgresql://postgres:postgres@localhost:5432/insights`
</Info>
